...
' #
' # description:
' # 	user form for entering the reply to a forum article.
' #
' # version:
...
strDesc    = "Here you can reply to a message in the " & forum_name & " forum"
%>
...
<!-- #include file="includes/header.asp" -->
		...
		<form action="<%=fh.getUriUserDoReply%>" method="POST"
			...
			<div align="left">
				<table border="0" cellspacing="0">
					...
					<tr>
						...
						<td valign="middle" colspan="2"><font size="1"
							face="Verdana"><input type="text" size="40"
							name="ArticlePassword" value="<%=getRndNr%>"> Set this only if you want to 

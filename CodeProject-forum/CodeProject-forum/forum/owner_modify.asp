...
strTitle   = "Modify a message"
strUpdate  = "15 Jun 2000"
forum_id   = Request.QueryString("forumid")
forum_name = fh.getForumName(forum_id)
strDesc    = "Here you can modify a message in the " & forum_name & " forum"

' ************************************************************

dim rs
set rs = fh.getArticleRs(Request.Form("id"))
...
<!-- #include file="includes/header.asp" -->
	...
	<body bgcolor="#FFFFFF">
		...
		<form action="<%=fh.getUriOwnerDoModify%>" method="post"
				...
				<table border="0" cellspacing="0">
					...
					<tr>
						...
						<td valign="middle" colspan="2"><font size="1"
							...
							name="ArticlePassword" value="<%=pw%>"> Set only, when you want to 
